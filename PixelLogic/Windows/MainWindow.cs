...
internal sealed partial class MainWindow : DxWindow, IConstructionParamsProvider
{
    ...
    public static MainWindow Create(WindowFactory factory)
    {
        if (factory == null)
        {
        ...
        return factory.CreateWindowEx(() => new MainWindow(), "PIXEL LOGIC");
    }

    public IConstructionParams GetConstructionParams()
    {
        return new FrameWindowNoRedirectionConstructionParams();
    }
}